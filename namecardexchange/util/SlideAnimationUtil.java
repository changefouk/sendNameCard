...
/**
 * Created by Administrator on 25/12/2560.
 */
...
public class SlideAnimationUtil {
    ...
    public static void slideInFromLeft(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.anim_slide_from_left);
    }
    ...
    public static void slideOutToLeft(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.anim_slide_to_left);
    }
    ...
    public static void slideInFromRight(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.anim_slide_from_right);
    }
    ...
    public static void slideOutToRight(Context context, View view) {
        runSimpleAnimation(context, view, R.anim.anim_slide_to_right);
    }
