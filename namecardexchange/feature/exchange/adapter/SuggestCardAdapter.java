...
public class SuggestCardAdapter extends RecyclerView.Adapter<SuggestCardAdapter.ViewHolder> {
    ...
    public SuggestCardAdapter(List<CardMdl> list, Context mContext, OnitemClick onitemClick) {
        this.list = list;
    ...
    @Override
    public SuggestCardAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            case CARD_ORIENTATION_VERTICAL:
                return new SuggestCardAdapter.ViewHolder(LayoutInflater.from(mContext)
    ...
    @Override
    public void onBindViewHolder(SuggestCardAdapter.ViewHolder holder, int position) {
